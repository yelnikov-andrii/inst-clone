...
export const HomeIcon = ({ active }: { active?: boolean }) => {
    return (
        <svg aria-label="Головна" fill="none" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Головна</title><path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill={active ? "#000" : "none"} stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
    )
}

export const SearchIcon = ({ active }: { active?: boolean }) => {
    return (
        <svg aria-label="Пошук" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Пошук</title><path d="M19 10.5A8.5 8.5 0 1 1 10.5 2a8.5 8.5 0 0 1 8.5 8.5Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width={active ? "3" : "2"}></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width={active ? "3" : "2"} x1="16.511" x2="22" y1="16.511" y2="22"></line></svg>
    )
}
...
export const CommentIcon = () => {
    return (
        <svg aria-label="Коментувати" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Коментувати</title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
    )
}
